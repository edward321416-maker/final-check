...
export const metadata: Metadata = { title: "FINAL CHECK — AI Submission Preflight", description: "공고와 제출파일의 근거를 확인하는 제출 전 검사. TASK 01 mock demo." };
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="ko"><body><SessionProvider><a className="skip-link" href="#main">본문으로 이동</a>
    ...
    <div className="shell"><Navigation /><main id="main">{children}</main><footer className="site-footer"><strong>FINAL CHECK</strong><span>확신은, 근거에서 시작됩니다.</span><span>TASK 01 · LOCAL DEMO</span></footer></div>
