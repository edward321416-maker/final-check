...
export interface ValidationResult {
  ...
  submission_evidence: Evidence | null; source_mode: "validator";
}
...
export interface CheckSession {
  ...
  source_mode: "validator" | "unavailable"; announcement_name: string | null;
  validation_profile: "frozen_v15" | null; engine_sha256: string | null;
